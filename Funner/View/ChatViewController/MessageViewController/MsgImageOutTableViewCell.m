...
@interface MsgImageOutTableViewCell()
...
@implementation MsgImageOutTableViewCell
...
- (void)fillContent:(NSDictionary *)dictMsg user:(UserData *)userData object:(AVObject *)object showTime:(BOOL)bShowTime {
    ...
    // warning label
    double dRadius = self.mLblWarning.frame.size.height / 2;
    [self.mLblWarning.layer setMasksToBounds:YES];
    [self.mLblWarning.layer setCornerRadius:dRadius];
